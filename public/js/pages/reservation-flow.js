...
const ReservationFlowPage = {
  ...
  systemVariables: {
    recruit: [
      ...
      { name: "url",      label: "回答ページURL", sample: "https://app.setouchi-stay.com/#/my-recruitment" },
    ...
    booking: [
      ...
      { name: "url",      label: "名簿ページURL",   sample: "https://app.setouchi-stay.com/#/guests" },
    ],
    staff: [
      { name: "staff",    label: "スタッフ名",  sample: "山田太郎" },
      { name: "date",     label: "対象日",      sample: "2026/04/20" },
      { name: "property", label: "物件名",      sample: "長浜民泊A" },
      { name: "url",      label: "マイページURL", sample: "https://app.setouchi-stay.com/#/my-dashboard" },
    ...
    invoice: [
      ...
      { name: "url",      label: "確認/作成ページURL", sample: "https://app.setouchi-stay.com/#/my-invoice-create" },
    ],
    cleaning: [
      ...
      { name: "url",      label: "チェックリストURL", sample: "https://app.setouchi-stay.com/#/my-checklist/xxx" },
    ],
    laundry: [
      { name: "date",     label: "清掃日",          sample: "2026/04/20" },
      { name: "property", label: "物件名",          sample: "長浜民泊A" },
    ...
    guestUpdate: [
      ...
      { name: "confirmUrl",    label: "確認URL",         sample: "https://app.setouchi-stay.com/#/guests?id=xxx" },
    ],
    parking: [
  ...
  _notifDefaults: {
    ...
    garbage_request:    { defaultMsg: "🗑️ ゴミ回収依頼\n\n{date} {property}\n{staff}さんの清掃完了時に「ゴミ回収依頼が必要」と報告がありました。\nゴミ回収の手配をお願いします。\n\n詳細: {url}", defaultTiming: "immediate", varGroup: "cleaning" },
  ...
  STEPS: [
    ...
    // ゴミ回収依頼 (清掃完了時にスタッフが「必要」を選んだ物件のみ発火。ON にした物件だけ完了画面に確認が出る)
    {
      key: "garbage_request",
      label: "ゴミ回収依頼",
      icon: "bi-trash",
    ...
    },
    {
      ...
      phase: 4,
      track: "owner",
      globalChannel: "invoice_confirmed",
      varGroup: "invoice",
      arrowTo: "owner",
      linkHash: "#/notifications",
      linkLabel: "通知設定",
  ...
  async _bindMailPreview(bodyEl, pid, bodyField, previewId) {
    ...
    const baseVars = {
      ...
      guestCount:   "4",
      editUrl:      "https://app.setouchi-stay.com/guest-form.html?edit=sample-token",
    ...
    try {
      ...
      sampleVars.guideUrl        = "https://app.setouchi-stay.com/guide/?propertyId=xxx";
    }
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label small" for="rfImportChkOverrides">
