  ...
  renderTabChecklist() {
    ...
    el.innerHTML = `
      <div id="mclAreaContent">
        ...
        ${area.memo ? `<div class="alert alert-warning py-1 px-2 mb-2" style="font-size:13px;white-space:pre-wrap;"><i class="bi bi-sticky"></i> ${this.escapeHtml(area.memo)}</div>` : ""}
        ...
        <div class="accordion-item">
          ...
          <div id="${collapseId}" class="accordion-collapse collapse show">
            <div class="accordion-body p-2">
              ${cat.memo ? `<div class="alert alert-warning py-1 px-2 mb-2" style="font-size:13px;white-space:pre-wrap;"><i class="bi bi-sticky"></i> ${this.escapeHtml(cat.memo)}</div>` : ""}
