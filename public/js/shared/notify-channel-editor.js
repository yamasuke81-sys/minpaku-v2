...
(function(global) {
  ...
  const NOTIFICATIONS = [
    ...
    { key: "invoice_confirmed", label: "請求書確定通知", desc: "Webアプリ管理者が請求書を確定した時にWebアプリ管理者/物件オーナーへ通知", icon: "bi-check2-circle", group: "invoice", varGroup: "invoice", defaultTiming: "immediate",
      defaultEnabled: true, defaultOwnerLine: true, defaultGroupLine: false, defaultStaffLine: false, defaultEmail: true,
