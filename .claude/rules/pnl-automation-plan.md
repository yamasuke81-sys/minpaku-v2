...
- **the Terrace 過去月(2025-09〜2026-04)の清掃費未計上は「過去は参考値」と割り切る**。当時アプリの清掃請求書機能を使っておらず invoices が存在しないため、**遡及して清掃費を計上しない**。過去月の pnl は売上ベースの参考値で、完全な損益は **2026-05以降のみ**。よって過去月の利益率は清掃費・経費が抜けており過大表示になっている点に留意(帳票を対外送付する場合は2026-05以降に限る)。
