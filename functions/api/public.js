...
router.post("/booking-request", express.json(), async (req, res) => {
  try {
    ...
    // カフェ都合の利用不可日の了承（有料駐車場を利用するとき、サイト側で同意必須にしている）
    const cafeParkingAcknowledged = body.cafeParkingAcknowledged === true;
